...
var CheckBox = class extends Switcher {
  ...
  addLabel(text, style) {
    ...
    if (!text)
      return;
    this.label = new Text(text ?? "", style ?? ((_a = this._style) == null ? void 0 : _a.text));
  ...
  get text() {
    var _a;
    return ((_a = this.label) == null ? void 0 : _a.text) ?? "";
  }
  ...
  set style(style) {
    ...
    if (this.label) {
      ...
      this.label.x = uncheckedView.width + 10 + (((_a = style.textOffset) == null ? void 0 : _a.x) ?? 0);
      this.label.y = (uncheckedView.height - this.label.height) / 2 + (((_b = style.textOffset) == null ? void 0 : _b.y) ?? 0);
    }
  }
...
var ProgressBar = class extends Container {
  ...
  setBackground(bg) {
    ...
    if ((_a = this.options) == null ? void 0 : _a.nineSlicePlane) {
      if (typeof bg === "string") {
...
var FancyButton = class extends ButtonContainer {
  ...
  adjustIconView(state) {
    ...
    (_a = this._views.iconView.anchor) == null ? void 0 : _a.set(0);
  ...
  initStateControl() {
    ...
    this.onUp.connect(() => {
      lib_exports.isMobile.any ? this.setState("default") : this.setState("hover");
    });
...
var Input = class extends Container {
  ...
  constructor(options) {
    ...
    this.on("pointertap", () => {
      ...
      lib_exports.isMobile.any && this.handleActivation();
    });
    if (lib_exports.isMobile.any) {
      window.addEventListener("touchstart", this.handleActivationBinding);
    } else if (!lib_exports.isMobile.any) {
  ...
  set bg(bg) {
    ...
    if (((_b = this.options) == null ? void 0 : _b.nineSlicePlane) && typeof bg === "string") {
  ...
  createInputField() {
    ...
    if (lib_exports.isMobile.android.device) {
      setTimeout(() => {
        input.focus();
        input.click();
      }, 100);
...
var List = class extends Container {
  ...
  arrangeChildren() {
    var _a, _b, _c, _d, _e;
    let x = ((_a = this.options) == null ? void 0 : _a.horPadding) ?? 0;
    let y = ((_b = this.options) == null ? void 0 : _b.vertPadding) ?? 0;
    const elementsMargin = ((_c = this.options) == null ? void 0 : _c.elementsMargin) ?? 0;
    let maxWidth = (_d = this.parent) == null ? void 0 : _d.width;
    if ((_e = this.options) == null ? void 0 : _e.horPadding) {
      ...
      switch (this.type) {
        ...
        default:
          ...
          if (child.x + child.width >= maxWidth && id > 0) {
            y += elementsMargin + child.height;
            x = ((_a2 = this.options) == null ? void 0 : _a2.horPadding) ?? 0;
            child.x = x;
            child.y = y;
          }
          x += elementsMargin + child.width;
...
var MaskedFrame = class extends Graphics {
  constructor(options) {
    super();
...
var ScrollBox = class extends Container {
  ...
  revertClick(item) {
    if (item.eventMode !== "auto") {
      lib_exports.isMobile.any ? item.emit("pointerupoutside", null) : item.emit("mouseupoutside", null);
...
var Select = class extends Container {
  constructor(options) {
    ...
    this.onSelect = new import_typed_signals7.Signal();
    if (options) {
      this.init(options);
    }
  }
  ...
  init({ closedBG, textStyle, items, openBG, selected, selectedTextOffset, scrollBox, visibleItems }) {
    ...
    if (!this.openButton) {
      this.openButton = new FancyButton({
        ...
        text: new Text((items == null ? void 0 : items.items) ? items.items[0] : "", textStyle),
      ...
      this.openButton.textView = new Text((items == null ? void 0 : items.items) ? items.items[0] : "", textStyle);
    ...
    if (!this.closeButton) {
      ...
      this.closeButton.textView = new Text((items == null ? void 0 : items.items) ? items.items[0] : "", textStyle);
      this.openButton.textOffset = selectedTextOffset;
    }
    if (!this.scrollBox) {
...
var Slider = class extends SliderBase {
  constructor(options) {
    ...
    __publicField20(this, "onUpdate", new import_typed_signals8.Signal());
    __publicField20(this, "onChange", new import_typed_signals8.Signal());
    this.sliderOptions = options;
  ...
  update(event) {
    ...
    const obj = event.currentTarget;
    const { x } = obj.parent.worldTransform.applyInverse(event.global);
    this.progress = this.validate(x / ((_a = this.bg) == null ? void 0 : _a.width) * 100);
